...
internal actual fun uriResource(uri: String): Resource {
    throw UnsupportedOperationException("URI resource is not supported in JS platform")
}

internal actual fun pathResource(path: String): Resource {
    throw UnsupportedOperationException("Path resource is not supported in JS platform")
}
